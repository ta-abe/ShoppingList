...
<html>
  ...
  <body onLoad = "document.F.submit():">
    ...
    <form method = "POST" action= "ShoppingListServlet">
      ...
      <BR>
      <input type = "text" name = "txtGoods" required style= "position : absolute ; left : 10px;"/>
      <input type = "number" name = "txtNumber" required min = "1" max = "999" style = "position : absolute ; left : 190px ;"/>
    ...
    <form method = "POST" action= "ShoppingListServlet">
      <table border = "1" width = "800" >
        ...
        <tr>
          ...
          <th><input type = "number" value = "<%=request.getAttribute("num"+i) %>" name = "lblNumber<%=request.getAttribute("UUID"+i)%>" required min = "1" max = "999"></th>
